...
const mongodbUrl = 'mongodb://localhost:27017/hengtai' // this will change whether project is in development or production. for production add 'process.env.DB_URL' in front of || then it go to heroku weblink.
